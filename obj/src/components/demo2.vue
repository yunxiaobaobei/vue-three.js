...
export default {
  ...
  methods: {
    ...
    // 创建网格模型
    createMesh () {
      this.planeGeometry = new THREE.PlaneGeometry(60,40) // 创建一个平面几何体对象PlaneGeometry
      const planeMaterial = new THREE.MeshLambertMaterial({ color: 0xffffff}) // 材质对象Material
